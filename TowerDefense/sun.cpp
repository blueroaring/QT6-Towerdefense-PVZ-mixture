...
Sun::Sun()
{
    /*dest = QPointF(290 + QRandomGenerator::global()->generate() % (82 * 7), 130 + QRandomGenerator::global()->generate() % (98 * 5));
...
Sun::Sun(QPointF pos)
{
   /* dest = QPointF(pos.x() + QRandomGenerator::global()->generate() % 30 - 15, pos.y() + QRandomGenerator::global()->generate() % 30 + 15);
