...
footballzombie::footballzombie(QPointF point,int Level,int Road)
{
    road=Road;
    level=Level;
    HP=800;nowHP=HP;
    ...
    // movie->start();
    image=new QImage(":/Zombies/Images/Zombies/Zombie/need/idle(2).png");
    counter=0;
    setStatus=1;
...
void footballzombie::advance(int phase)
{
    ...
    case 0:
        ...
        {
            delete image;
            image = new QImage(":/Zombies/Images/Zombies/Zombie/need/death(2).png");
            update();
    ...
    case 2:{
        ...
        {
            delete image;
            image = new QImage(":/Zombies/Images/Zombies/Zombie/need/eat(3).png");
            update();
